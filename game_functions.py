...
def check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, 
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets, audio)
            break
       
def check_bullet_alien_collision(ai_settings, screen, stats, sb, ship, 
                                 aliens, bullets, audio):
    """Respond to bullet-alien collisions."""
    # Remove to bullet-aliens that have collided.
    collisions = pygame.sprite.groupcollide(bullets, aliens, True, True)
    if collisions:
        audio.play_alien_died_sound()
...
def ship_hit(ai_settings, screen, stats, sb, ship, aliens, bullets, audio):
    """Respond to ship being hit by alien."""
    if stats.ships_left > 0:
        # Play death sound effect
        audio.play_player_died_sound()
...
def start_new_level(ai_settings, screen, stats, sb, ship, 
                                 aliens, bullets):
    """Empty the screen, increase level, and create new fleet."""
    bullets.empty()
...
def update_aliens(ai_settings, screen, stats, sb, ship, 
    ...
    and then update the postions of all aliens 
    in the fleet.
    """
    ...
    check_aliens_bottom(ai_settings, screen, stats, sb, ship, aliens, bullets, audio)
